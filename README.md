...
```
pip install dist/nomad-pymodaq-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-pymodaq" is free and open source software
